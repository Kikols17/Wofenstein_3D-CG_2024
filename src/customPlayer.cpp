...
//--------------------------------------------------------------
// public
customPlayer::customPlayer(ofVec3f _position, ofVec3f _rotation, ofVec3f _scale) : customPhysicsObjectMovable(_position, _rotation, _scale, ofVec3f(1.0,0.0,0.0), NULL, vector<customColisionBox*>({new customColisionBox(_position, _rotation, _scale, ofVec3f(1.0,0.0,0.0), 0, vector<int>({1,2,3}), -0.2, -0.7, -0.2, 0.2, 0.7, 0.2)})) {
...
void customPlayer::shoot() {
    ...
    for (int i=0; i<10; i++) {
        customParticle* p = new customParticle(this->cam.target, ofVec3f(0, 0, 0), ofVec3f(0.07, 0.07, 0.07), ofVec3f(0.1, 0.1, 0.1), ofRandom(0.95f, 0.99f), ofRandom(1000, 3000), -1, vector<int>({}));
